...
(function() {
  ...
  initDirections = function() {
    var directionsPolyline, directionsPolylineOptions, directionsService, getDirections, isiOS;
    ...
    $(document).on('click', '.directions_button', function(e) {
      var $me, coordinates;
    ...
    return isiOS = navigator.userAgent.match(/(iPod|iPhone|iPad)/);
  };
